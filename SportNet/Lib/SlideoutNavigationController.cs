...
namespace MonoTouch.SlideoutNavigation
{
	...
	public class SlideoutNavigationController : UIViewController
	{
		...
		{
			var button = new UIBarButtonItem (LeftMenuButtonText, UIBarButtonItemStyle.Plain, (s, e) => ShowMenuLeft ());

			var custom = new UIButton (new RectangleF (0, 0, 26, 15));
			custom.SetBackgroundImage(UIImage.FromFile("./Assets/menu.png"), UIControlState.Normal);
			custom.TouchUpInside += (sender, e) => ShowMenuLeft();
